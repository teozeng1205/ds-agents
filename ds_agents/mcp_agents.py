...
class ProviderAuditMCPAgent(BaseMCPAgent):
    ...
    def __init__(self) -> None:
        instructions = (
            ...
            "   • Top site issues (replace PROVIDER_CODE and DAYS; include COALESCE(issue_reasons, issue_sources) as issue_label):\n"
            ...
            "     LIMIT 10;\n"
            "   • Scope breakdown (add/remove dims from {obs_hour,pos,od,cabin,triptype,los}; keep issue label):\n"
            ...
            "- Issue labels must come from COALESCE(issue_reasons, issue_sources) and should exclude empty strings—surface the label in answers.\n"
